...
int mineCardEffect(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case adventurer:
            return adventureCardEffect(state, currentPlayer);
        ...
        case mine:
            return mineCardEffect(state, handPos, currentPlayer, choice1, choice2);
        ...
        case great_hall:
            greathallEffect(handPos, currentPlayer, state);
